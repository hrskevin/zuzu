...
public final class ZuzuIdentifier extends ZuzuToken implements Comparable<ZuzuIdentifier>
{
	 ...
	 * <ul>
	 * <li>Converts instances of '-' followed by a lowercase letter to just the uppercase version of the letter
	 * (e.g. "get-value" becomes "getValue")</li>
	 * <li>Converts identifier ending in '?' by converting the first letter to uppercase, prepending "is"
	 * and removing the '?' (e.g. "done?" becomes "isDone").</li>
	 * </ul>
	 */
	...
	public static final class HygieneTag implements Comparable<HygieneTag>, Serializable
	{
		...
		/**
		 * Compares two potentially null tags where null tag comes before non-null tags
		 * and ordering is otherwise arbitrary (but consistent).
		 */
